...
map <leader>q :e $PWD/buffer.md<cr>

" Quickly open a markdown buffer for scribble
" map <leader>x :e $PWD/buffer.md<cr>
...
" ref: https://stackoverflow.com/questions/8640276/how-do-i-change-my-vim-highlight-line-to-not-be-an-underline
